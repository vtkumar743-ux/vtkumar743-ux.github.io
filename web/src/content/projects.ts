export type Project = {
  ...
  highlights: string[];
  featured: boolean;
  cover: string;        // 4K mockup, generated by scripts/covers.mjs
...
export const projects: Project[] = [
  {
    slug: "conduit",
    cover: "/img/projects/conduit.webp",
    name: "Conduit",
  ...
  {
    slug: "taskflow",
    cover: "/img/projects/taskflow.webp",
    name: "TaskFlow",
  ...
  {
    slug: "ledger",
    cover: "/img/projects/ledger.webp",
    name: "Ledger",
